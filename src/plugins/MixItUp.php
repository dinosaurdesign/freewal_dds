<section>
    <div class="container">
        <div class="row">
            <ul class="controls">
                <li class="control" data-filter="all">Все работы</li>
                <li class="control" data-filter=".green">Меню</li>
                <li class="control" data-filter=".blue">Сайты</li>
                <li class="control" data-filter=".pink">Айдентика</li>
            </ul>

            <div class="container1">

                <div class="mix green"><img class="img-fluid"
                ...
                <div class="mix blue"><img class="img-fluid"
                                           ...
                                           alt=""></div>
                <div class="mix pink"><img class="img-fluid"
